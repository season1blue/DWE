...
export DIR_SEARCH="E:\Season\MyCode\MM\UMI\data/wikiperson/search_100_random.json"
export PATH_ANS="E:\Season\MyCode\MM\UMI\data/wikiperson/entity_list.json"
export PATH_NEG_CONFIG="E:\Season\MyCode\MM\UMI\data/wikiperson/neg.json"
export DIR_PREPRO="E:\Season\MyCode\MM\UMI\data/wikiperson"
export DATASET="person"
export IMG_PATH="E:\Season\MyCode\MM\UMI\data/ImgData/"
export GT_TYPE="text"  #image text both

#export OVERWRITE=False

export MODE="train"

export EPOCHS=400  #300
export LOGGING_STEPS=1243
export SAVE_STEPS=1244 #1244  # 0 represent not save
