...
def gen_gt_feats(args):
    ...
    ne2qid = json.load(open(entity_path, encoding="utf-8"))
    ...
    for index, key in tqdm(enumerate(keys_ordered), total=len(keys_ordered)):
        ...
        if key in qid2ne.keys():
            entity = qid2ne[key]
            # input_sent = entity + " [SEP]. " + input_sent
...
def main():
    ...
    parser.add_argument("--path_brief", default="../../data/richpedia/brief.json", type=str)
    parser.add_argument("--path_entity", default="../../data/richpedia/ne2qid.json", type=str)
    parser.add_argument("--path_property", default="../../data/richpedia/property.json", type=str)
    parser.add_argument("--gt_type", default="property", type=str)
    parser.add_argument("--dir_output", default="../../data/richpedia", type=str)
